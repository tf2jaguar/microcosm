...
public class BusinessException extends RuntimeException {
    ...
    private static final long serialVersionUID = 8334074865591050440L;
    private Integer errno;


    public BusinessException(Integer errno, String errMsg) {
        super(errMsg);
        this.errno = errno;
    }
    ...
    public BusinessException(@Nullable ExceptionEnums errorEnum) {
    ...
    public BusinessException(@Nullable ExceptionEnums errorEnum, String... message) {
